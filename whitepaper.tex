...
%  \cleardoublepage
  ...
  The \href{https://github.com/seL4/microkit}{seL4 Microkit} reduces
...
\fi
  ...
  the two Linux VMs communicating via CAmkES connectors (this work was
  done prior to the existence of the Microkit). At the same
